...
posneg_cases = ['ID20','ID23','ID24','ID39','ID41','ID42','ID53','ID76']
negneg_cases = ['ID75']
...
negpos_cases = sizes_df[sizes_df['studyid'].isin(negpos_cases)]['size'].values
...
negpos_diam = (3*negpos_cases/(4*np.pi))**(1/3)/5
