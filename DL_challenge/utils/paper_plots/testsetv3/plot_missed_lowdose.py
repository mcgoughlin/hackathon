...
meta_folder = '/Users/mcgoug01/Cambridge University Dropbox/William McGough/AIvsRad/AI/predictions_v3/lowdose_test_ROCv3'
...
#posneg= ['R ID10', 'L ID16', 'L ID20', 'L ID23', 'L ID24', 'L ID27', 'R ID41', 'R ID42', 'L ID53', 'L ID59', 'L ID62']
posneg_cases = ['ID10','ID16','ID20','ID23','ID24','ID27','ID41','ID42','ID53','ID59','ID62']
#find sizes for each in posneg
# negneg_cases = ['L ID39', 'R ID47', 'R ID75', 'L ID76', 'L ID85']
negneg_cases = ['ID39','ID47','ID75','ID76','ID85']
negpos_cases = ['ID18']
...
for i in range(4):
    ...
    if i == 0:
        ...
        pred_slice = 33
        print('39 pred shape is',low_dose.shape)
        ax[i,0].imshow(low_dose[pred_slice][upper_left[1]:lower_right[1],upper_left[0]:lower_right[0]],cmap='gray',
                       vmin=-200,vmax=200)
        ax[i,1].imshow(fulldose[pred_slice][upper_left[1]:lower_right[1],upper_left[0]:lower_right[0]],cmap='gray',
                         vmin=-200,vmax=200)
        ...
        if i==3:
            pred_slice = pred_slice+4
        ax[i,0].imshow(low_dose[pred_slice][upper_left[1]:lower_right[1],upper_left[0]:lower_right[0]],cmap='gray',
                       vmin=-200,vmax=200)
        ax[i,1].imshow(fulldose[pred_slice][upper_left[1]:lower_right[1],upper_left[0]:lower_right[0]],cmap='gray',
                         vmin=-200,vmax=200)
    print('contrast enhanced shape is',contrastenhanced.shape)
    print('label slice is',label_slice)
    ...
    # if i ==1:
    #     print('42 pred shape is',fulldose_pred.shape)
    #     print('42 pred slice is',pred_slice)
    #     pred_slice = 52
    ...
    if i==2:
        ...
        ax[i, 3].text(bins[9], 7.2, str(counts[9]), fontsize=11)
