...
names = ['Iztok','Cathal','Hania'] + names_sub_folders
folders = [iztok_pred_csv_fp, cathal_pred_csv_fp,hania_pred_csv_fp] + sub_folders
ai_results = [[100,0]]
...
plt.annotate('Sensitivity {:.1f}%\nSpecificity {:.1f}%'.format(high_acc[0],high_acc[1]),xy=(high_acc[1],high_acc[0]),xytext=(high_acc[1]-50,high_acc[0]-10),
             fontsize=14,
