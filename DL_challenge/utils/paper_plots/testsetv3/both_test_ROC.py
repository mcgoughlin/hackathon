...
axin = ax.inset_axes([0.2, 0.45, 0.3, 0.45])
...
axin.scatter([cathal_low[1],hania_low[1]],[cathal_low[0],hania_low[0]],label='Trainee Low',marker='.',s=150,linestyle='--',facecolors='none',edgecolors='b',zorder=2)
axin.scatter([iztok_low[1]],[iztok_low[0]],label='Consultant Low',marker='.',s=150,linestyle='--',facecolors='none',edgecolors='r',zorder=2)

#plot full dose radiologists
axin.scatter([iztok_full[1]],[iztok_full[0]],label='Consultant Full',c='r',marker='.',s=150,zorder=2)
axin.scatter([cathal_full[1],hania_full[1]],[cathal_full[0],hania_full[0]],label='Trainee Low',c='b',marker='.',s=150,
                zorder=2)
