...
if full_dose:
    ...
    title = 'ROC Curve on Full Dose Internal Test ({:.3f})'
else:
    meta_folder = '/Users/mcgoug01/Cambridge University Dropbox/William McGough/AIvsRad/AI/predictions_real/lowdose_ROC'
    title = 'ROC Curve on Low Dose Internal Test ({:.3f})'
...
plt.title(title.format(auc),fontdict={'fontsize':18})
