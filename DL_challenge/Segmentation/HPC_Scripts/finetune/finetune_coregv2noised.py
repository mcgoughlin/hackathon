...
for vf in vfs:
    # path_to_model = '/bask/projects/p/phwq4930-renal-canc/data/seg_data/trained_models/kits_nooverlap_v2/{}mm_kidneybinary_customPP/6_tot/fold_0/network_weights'.format(
    #     spacing)
