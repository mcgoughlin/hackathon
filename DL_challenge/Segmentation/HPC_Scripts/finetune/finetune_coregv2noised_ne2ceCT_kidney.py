...
model_name = '6_finetune_l2-0.0_cce1.0_2e-05lr_0.999993lg_16bs_1000ep_4gpus'
...
for vf in vfs:
    opt_save_loc = '/bask/projects/p/phwq4930-renal-canc/data/seg_data/ne2ceCT/kidney_4_kidney_ckpt_delay/l2-0.0_cce1.0_2e-05lr_0.999993lg_16bs_1000ep_4gpus/optimizer_state'
    checkpoint = torch.load(opt_save_loc)
    load_model = infer_network.UNet_regressivehead_wrapper(get_3d_featureoutput_unet(1, 2, 6, filters=32, filters_max=1024),
                                                           6,start_filters=32)
    ...
    # transfer state dict from loaded model to new model
    model.network.load_state_dict(load_model.UNet.state_dict())
