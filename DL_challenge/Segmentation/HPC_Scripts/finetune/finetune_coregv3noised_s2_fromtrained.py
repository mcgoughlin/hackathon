...
efr = 1000
dfr = 100
pretrain_name = 'paired_pretrain_segtrained'
# model_name = 'del'

model_name = 'finetune_coregv3noised_s2_fromtrained_{}_{}'.format(efr, dfr)
...
for vf in vfs:
    ...
    model.network.load_state_dict(torch.load(path_to_model, map_location=dev), strict=False)
