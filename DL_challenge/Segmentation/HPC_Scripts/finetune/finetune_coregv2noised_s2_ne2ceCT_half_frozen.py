...
#set manual seeds for torch and numpy
torch.manual_seed(0)
...
model_params['architecture'] = 'UNet_classhead'
model_params['training']['class_seg_label'] = 1
model_params['training']['vol_thresh_mm'] = 500
model_params['training']['class_weight'] = 0.1
