...
model_params['training']['opt_params'] = {'lr': lr,
                                          'betas': (0.95, 0.9),
                                          'eps': 1e-08}
model_params['training']['lr_params'] = {'n_warmup_epochs': 25, 'lr_max': 0.0001}
...
model_name = model_name + '_segfiltered'
for vf in vfs:
    opt_save_loc = '/bask/projects/p/phwq4930-renal-canc/data/seg_data/ne2ceCT/kidney_2_cancer_ckpt_delay_filtered/{}/optimizer_state'.format(pretrain_name)
