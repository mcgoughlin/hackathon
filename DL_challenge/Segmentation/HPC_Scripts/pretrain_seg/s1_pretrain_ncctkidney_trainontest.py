...
data_name = 'final_pairedpretrain_nc'
spacing = 4
fold = int(sys.argv[1])

preprocessed_name = '4mm_kidney_customPP'
model_name = '6,3x3x3,32_trainontest'
...
for vf in vfs:
    path_to_model = '/rds/project/rds-sDuALntK11g/trained_models/kits_nooverlap_v2/4mm_kidneybinary_customPP/6_tot/fold_0/network_weights'
