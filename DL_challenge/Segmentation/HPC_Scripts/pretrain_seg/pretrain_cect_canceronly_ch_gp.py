...
data_name = 'kits_add_nooverlap_v2'
spacing = 2
fold = 0

preprocessed_name = '2mm_cancer_customPP'
model_name = '6_tot_ch_talkative_cls10'
...
model_params['training']['class_weight'] = 10
...
model_params['data']['trn_dl_params']['min_biased_samples'] = (model_params['data']['trn_dl_params']['batch_size'] // 4)*3
