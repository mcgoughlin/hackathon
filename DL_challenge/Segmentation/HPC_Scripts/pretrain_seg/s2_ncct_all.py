...
data_name = 'masked_final_pairedpretrain_nc_literallyall'
spacing = 2
fold = 0
...
for vf in vfs:
    path_to_model = '/rds/project/rds-sDuALntK11g/trained_models/masked_kits_add_nooverlap_v2_small/2mm_canceronly_customPP/6_tot_ch_talkative_cls1/fold_0/network_weights'
    ...
    model.network.load_state_dict(torch.load(path_to_model),strict=False)
