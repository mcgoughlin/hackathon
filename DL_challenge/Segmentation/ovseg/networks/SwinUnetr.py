...
import KCD.Segmentation.ovseg.networks.swinunetr_heads as head
...
class Trans_Unetr(nn.Module):
    def __init__(
        ...
        self.transformer = SwinTransformer_Unetr(patch_size=self.patch_size,
